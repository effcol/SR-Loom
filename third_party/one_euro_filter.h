...
// (https://github.com/effcol/leia-track-app-XYZ, MIT) which itself
// adapted the original Casiez reference to a header-only, float,
// value-types, no-exceptions form. SR Loom uses this in the VR head-
// tracked viewer to smooth SR-tracker yaw/pitch -- the adaptive
// cutoff stays calm when the head is still (kills tracker jitter)
// and snaps to high responsiveness during fast head turns.
#pragma once
#include <cmath>
